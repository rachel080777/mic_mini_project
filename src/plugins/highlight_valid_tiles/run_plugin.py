"""
This script is called by the plugin-wrapper, highlight_valid_tiles.js, which passes down the
...
from highlight_valid_tiles import highlight_valid_tiles

logger = logging.getLogger('highlight_valid_tiles')
...
plugin = highlight_valid_tiles(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
